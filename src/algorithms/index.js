...
export async function bubbleSort(arr, setColorArray, delay) {
  return await bubbleSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { insertionSortWithStop } from "./insertionSort.js";
export async function insertionSort(arr, setColorArray, delay) {
  return await insertionSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { selectionSortWithStop } from "./selectionSort.js";
export async function selectionSort(arr, setColorArray, delay) {
  return await selectionSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { mergeSortWithStop } from "./mergeSort.js";
export async function mergeSort(arr, setColorArray, delay) {
  return await mergeSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { quickSortWithStop } from "./quickSort.js";
export async function quickSort(arr, setColorArray, delay) {
  return await quickSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}
...
export async function shellSort(arr, setColorArray, delay) {
  return await shellSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { heapSortWithStop } from "./heapSort.js";
export async function heapSort(arr, setColorArray, delay) {
  return await heapSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}

import { radixSortWithStop } from "./radixSort.js";
export async function radixSort(arr, setColorArray, delay) {
  return await radixSortWithStop(arr, noopSetArray, setColorArray, delay, makeStopRef(), noopUpdateStats);
}
