...
const TreePage = () => {
  ...
  return (
    <div className="theme-container">
      ...
      <TreeVisualizer defaultAlgorithm={selectedAlgorithm} autoLoadExample={true} />
      ...
      <div className="theme-card" style={{ marginTop: '2rem' }}>
        ...
        <div style={{
          ...
          <strong>Note:</strong> This is the implementation code for <strong>{displayName[selectedAlgorithm]}</strong> in <strong>{selectedLanguage.toUpperCase()}</strong>.
        </div>
      </div>
    </div>
  );
