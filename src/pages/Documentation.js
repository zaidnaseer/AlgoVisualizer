...
const AlgorithmDocumentation = () => 
	...
	[data-theme="light"] .documentation-footer h3,
	[data-theme="light"] .documentation-footer h4 {
		color: #23272f !important;
	}
	[data-theme="light"] .documentation-footer .implemented-badge {
		background: linear-gradient(45deg, #e0ffe0, #b2f5b2) !important;
		color: #228b22 !important;
		border: 1px solid #b2f5b2 !important;
	}
	[data-theme="light"] .documentation-footer .comingsoon-badge {
		background: #fffbe6 !important;
		color: #bfa100 !important;
		border: 1px solid #ffe066 !important;
	}
	[data-theme="light"] .documentation-footer .footer-note {
		background: #f3f7fa !important;
		color: #23272f !important;
		border: 1px solid #b8c5d1 !important;
	}
	[data-theme="dark"] .documentation-footer {
		background: rgba(26, 26, 46, 0.95) !important;
		color: #e0e6ed !important;
		border-top: 1px solid rgba(102, 204, 255, 0.2) !important;
	}
	[data-theme="dark"] .documentation-footer h3,
	[data-theme="dark"] .documentation-footer h4 {
		color: #66ccff !important;
	}
	[data-theme="dark"] .documentation-footer .implemented-badge {
		background: linear-gradient(45deg, #4ade80, #22c55e) !important;
		color: #ffffff !important;
		border: none !important;
	}
	[data-theme="dark"] .documentation-footer .comingsoon-badge {
		background: rgba(255, 215, 61, 0.2) !important;
		color: #ffd93d !important;
		border: 1px solid rgba(255, 215, 61, 0.3) !important;
	}
	[data-theme="dark"] .documentation-footer .footer-note {
...
=======
	...
	const AlgorithmCard = ({ algorithm }) => {
		// Consistent dark theme color for Bubble Sort card
		const isDark = typeof document !== 'undefined' && document.documentElement.getAttribute('data-theme') === 'dark';
		const cardBg = isDark ? '#232336' : undefined;
		const cardColor = isDark ? '#e0e6ed' : undefined;
		return (
			<div
			...
			<div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '16px' }}>
				...
				{algorithm.implemented ? (
					<div className="implemented-badge" style={{
						background: 'linear-gradient(45deg, #e0ffe0, #b2f5b2)',
						color: '#228b22',
						padding: '4px 12px',
						borderRadius: '16px',
						fontSize: '12px',
					...
					<div className="comingsoon-badge" style={{
						background: '#fffbe6',
						color: '#bfa100',
						padding: '4px 12px',
						borderRadius: '16px',
	...
	// Unified theme CSS for documentation page
	const docTheme = `
	[data-theme="light"] .documentation-root {
		background: #fff !important;
		color: #23272f !important;
	}
	[data-theme="light"] .documentation-root :not(.documentation-root) {
		color: #23272f !important;
		background: transparent;
		box-shadow: none;
	}
	[data-theme="light"] .documentation-root .AlgorithmCard {
		background: #fff !important;
		color: #23272f !important;
		box-shadow: 0 2px 8px #ececec !important;
		border: 1px solid #e0e0e0 !important;
	}
	[data-theme="light"] .documentation-root input {
		background: #f5f7fa !important;
		color: #23272f !important;
		border: 1px solid #e0e0e0 !important;
	}
	[data-theme="light"] .documentation-root input::placeholder {
		color: #6b7280 !important;
	}
	[data-theme="light"] .documentation-root .category-title {
		background: #f1f1f5 !important;
		color: #444 !important;
	}
	[data-theme="light"] .documentation-root .implemented-badge {
		background: linear-gradient(45deg, #e0ffe0, #b2f5b2) !important;
		color: #228b22 !important;
		border: 1px solid #b2f5b2 !important;
	}
	[data-theme="light"] .documentation-root .comingsoon-badge {
		background: #fffbe6 !important;
		color: #bfa100 !important;
		border: 1px solid #ffe066 !important;
	}

	[data-theme="dark"] .documentation-root {
		background: #232336 !important;
		color: #e0e6ed !important;
	}
	[data-theme="dark"] .documentation-root :not(.documentation-root) {
		color: #e0e6ed !important;
		background: transparent;
		box-shadow: none;
	}
	[data-theme="dark"] .documentation-root .AlgorithmCard {
		background: #232336 !important;
		color: #e0e6ed !important;
		box-shadow: 0 2px 8px #181824 !important;
		border: 1px solid #232346 !important;
	}
	[data-theme="dark"] .documentation-root input {
		background: #181824 !important;
		color: #e0e6ed !important;
		border: 1px solid #232346 !important;
	}
	[data-theme="dark"] .documentation-root input::placeholder {
		color: #8a94a6 !important;
	}
	[data-theme="dark"] .documentation-root .category-title {
		background: #232346 !important;
		color: #b8c5d1 !important;
	}
	[data-theme="dark"] .documentation-root .implemented-badge {
		background: linear-gradient(45deg, #4ade80, #22c55e) !important;
		color: #ffffff !important;
		border: none !important;
	}
	[data-theme="dark"] .documentation-root .comingsoon-badge {
		background: rgba(255, 215, 61, 0.2) !important;
		color: #ffd93d !important;
		border: 1px solid rgba(255, 215, 61, 0.3) !important;
	}
	...
	return (
		<React.Fragment>
			...
			{/* This is the section shown in your screenshot */}
			{/* =============================== */}
			...
			<div
				style={{
					...
					background: (typeof document !== 'undefined' && document.documentElement.getAttribute('data-theme') === 'light')
						? '#b5e6b9ff '
						: '#232336', // restore previous dark background
					...
					<div style={{
						...
						<input
							...
							style={{
								...
								background: isLightTheme ? '#f5f7fa' : 'rgba(26, 26, 46, 0.9)',
								border: isLightTheme ? '1px solid #e0e0e0' : '1px solid rgba(102, 204, 255, 0.3)',
								borderRadius: '25px',
								color: isLightTheme ? '#23272f' : '#e0e6ed',
								fontSize: '14px',
								outline: 'none',
								transition: 'all 0.3s ease'
							}}
							onFocus={(e) => {
								...
								e.target.style.boxShadow = isLightTheme ? '0 0 0 3px rgba(102, 204, 255, 0.15)' : '0 0 0 3px rgba(102, 204, 255, 0.1)';
							}}
							onBlur={(e) => {
								e.target.style.borderColor = isLightTheme ? '#e0e0e0' : 'rgba(102, 204, 255, 0.3)';
			...
			{/* Footer Section */}
			<style>{docFooterTheme}</style>
			<div
				className="documentation-footer"
				style={{
					padding: '40px 20px',
					textAlign: 'center',
				}}
