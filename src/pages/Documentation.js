...
const AlgorithmDocumentation = () => {
    ...
    const [selectedLegendCard, setSelectedLegendCard] = useState(null);
        ...
        <div style={{
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: isActive 
                                            ...
                                            : themeStyles.categoryBackground,
                                        color: isActive ? '#1a1a2e' : '#66ccff',
                                        border: `1px solid ${isActive ? '#66ccff' : themeStyles.categoryBorder}`,
                                        borderRadius: '25px',
                                        cursor: 'pointer',
                                        fontSize: '14px',
                                        fontWeight: '600',
                                    ...
                                    onMouseLeave={(e) => {
                                        if (!isActive) {
                                            e.target.style.background = themeStyles.categoryBackground;
            ...
            <div style={{
                ...
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    <h3 style={{
                        color: theme === 'light' ? '#0077cc' : '#66ccff',
                        marginBottom: '16px',
                        fontSize: '20px',
                        fontWeight: '600'
                    }}>
